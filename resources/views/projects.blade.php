...
<body class="text-gray-800">
    <main class="py-16 md:py-24 flex-grow">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <h1 class="text-5xl lg:text-6xl font-extrabold text-center text-gray-900 mb-4">
            ...
            <!-- Daftar Proyek (Grid) -->
                ...
                @foreach ($projects as $project)
                    <a href="{{ $project->detail_link ?? '#' }}" class="project-card block bg-white rounded-xl overflow-hidden shadow-xl border border-gray-100">
                            ...
                            <div class="flex flex-wrap gap-2">
                                ...
                                @if (is_array($project->technologies))
                                    @foreach ($project->technologies as $tech)
                                        {{-- Anda bisa menyesuaikan warna tag berdasarkan nama teknologi --}}
