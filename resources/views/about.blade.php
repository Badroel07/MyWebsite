...
<body class="bg-gray-50 text-gray-800">
    ...
    <main>
<!-- Bagian Hero/Intro -->
<section id="intro" class="py-16 md:py-24 lg:py-32 bg-white relative overflow-hidden">
  ...
  <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      ...
      <div class="flex justify-center lg:justify-end">
        <img src="https://placehold.co/400x550/4f46e5/ffffff?text=FOTO+CHIKAL"
        ...
        <section id="detail" class="py-16 md:py-24 bg-gray-50">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                <h2 class="text-3xl font-bold text-center text-gray-900 mb-12 border-b-4 border-blue-500 inline-block pb-1">Perjalanan & Filosofi Saya</h2>
                <div class="max-w-4xl mx-auto text-lg text-gray-700 leading-relaxed grid grid-cols-1 md:grid-cols-2 gap-10">
                    ...
                    <div class="md:col-span-2">
                        <h3 class="text-2xl font-semibold text-gray-900 mb-3 flex items-center mt-6">
        ...
        <section id="keahlian" class="py-16 md:py-24 bg-white">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
